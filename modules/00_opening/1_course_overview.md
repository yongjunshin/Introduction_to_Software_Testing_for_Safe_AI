...
- **Basic PyTorch programming knowledge** (for implementing and testing neural networks)
- *No prior knowledge of software engineering and testing principles required* - this course will cover the fundamentals
